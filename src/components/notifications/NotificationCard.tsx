        ...
        styles.card,
        {
          backgroundColor: pressed
            ? isDarkTheme
              ...
              : 'rgba(255, 255, 255, 1)'
            : cardBg,
          borderColor: variantColors.cardBorder,
        },
      ]}
